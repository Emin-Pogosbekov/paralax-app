...
const Masthead: React.FC = () => {
    return (
        <div className='min-h-screen flex flex-col items-center justify-center'>
            ...
            <div className="flex-grov-0 pt-10 transition-opacity duration-1000">
                <Image src='/assets/icons/logo.svg' width={128 / 3} height={114 / 3} alt='logo' />
            </div>
            ...
            <div className="flex-grow-0 pb-20 md:pb-10 transition-all duration-1000">
                <Image src='/assets/icons/arrow-down.png' width={180 / 3} height={180 / 3} alt='scroll down' />
            </div>
